...
void Peaton::move(Cell** map, Player& player)
{
    ...
    {
    case 1:
        if (!(map[peatonPos.x][peatonPos.y - 1] == Cell::PARED || map[peatonPos.x][peatonPos.y - 1] == Cell::COCHE || map[peatonPos.x][peatonPos.y - 1] == Cell::PEAJE))
        {
    ...
    case 2:
        ...
        break;
    case 3:
        if (!(map[peatonPos.x - 1][peatonPos.y] == Cell::PARED || map[peatonPos.x - 1][peatonPos.y] == Cell::COCHE || map[peatonPos.x - 1][peatonPos.y] == Cell::PEAJE))
        {
            map[peatonPos.x][peatonPos.y] = Cell::VACIO;
            peatonPos.x--;
            map[peatonPos.x][peatonPos.y] = Cell::PEATON;
